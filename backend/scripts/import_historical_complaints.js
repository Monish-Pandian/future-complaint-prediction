...
async function importHistoricalComplaints() {
  try {
    ...
    if (existingCount > 0) {
      console.log('[Import] Collection not empty. Skipping import to preserve existing data.');
      console.log('[Import] If you want to re-import, manually clear the collection first.');
